...
export default {
  ...
  methods: {
    ...
    initEventListeners() {
      this.$el.buttons.next.addEventListener("click", () =>
        this.swapCards("right")
      );
      this.$el.buttons.prev.addEventListener("click", () =>
        this.swapCards("left")
      );
    },
    swapCards(direction: any) {
      const currentCardEl =
        this.$el.cardsContainerEl.querySelector(".current--card");
      const previousCardEl =
        this.$el.cardsContainerEl.querySelector(".previous--card");
      const nextCardEl = this.$el.cardsContainerEl.querySelector(".next--card");

      const currentBgImageEl =
        this.$el.appBgContainerEl.querySelector(".current--image");
      const previousBgImageEl =
        this.$el.appBgContainerEl.querySelector(".previous--image");
    ...
    changeInfo(direction: any) {
      let currentInfoEl =
        this.$el.cardInfosContainerEl.querySelector(".current--info");
      let previousInfoEl =
        this.$el.cardInfosContainerEl.querySelector(".previous--info");
      let nextInfoEl =
        this.$el.cardInfosContainerEl.querySelector(".next--info");
